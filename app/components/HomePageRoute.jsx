...
export default function HomePageRoute() {
  ...
  return (
    <>
    <Routes>
<Route path="/imgtextsection" element={<ImageTextSection/>}/>
<Route path="/slider" element={<LogoSlider/>}/>
<div className="text-banner">
<Route path="/banner" element={ <NewBanner
...
/>}/>
  ...
  <Route path="/trustbadges" element={<TrustBadges badges={customBadges} count={4} />}/>
  </Routes>
    </>
  )
}
